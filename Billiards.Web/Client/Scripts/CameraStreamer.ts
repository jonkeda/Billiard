namespace BlazorCameraStreamer.Scripts {
    /**
     * Interface representing a DotNetObject
     */
    ...
    export class CameraStreamerInterop {
        ...
        /**
         * Constraints used for the MediaStream (used to specify height, width, camera, audio etc.) 
         */
        ...
        /**
         * The name of the method that should be invoked when a frame is received 
         */
        private _invokeIdentifier: string;

        /**
         * Whether the provided method should be invoked when a frame is received 
         */
